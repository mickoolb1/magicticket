...
export const artists: Artist[] = [
  {
    ...
    bio: "Artista multidisciplinaria, Dj de música electrónica desde el 2021. Especializada en Ecstatic Dance, dedicada a compartir momentos de mágia sonora principalmente en spot naturales y atardeceres."
  },
  {
    id: "amardevolcan",
    name: "Amardevolcan",
